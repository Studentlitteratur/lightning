...
projects[oauth2_server][version] = 1.0-beta1
...
libraries[progress-tracker][download][type] = git
libraries[progress-tracker][download][url] = https://github.com/NigelOToole/progress-tracker.git
libraries[progress-tracker][download][branch] = v1.4.0
libraries[progress-tracker][download][revision] = 130c94b41879f30ece6c3ca8ff6767d10b6b803b
libraries[react][type] = library
libraries[react][download][type] = git
libraries[react][download][url] = https://registry.npmjs.org/react/-/react-16.2.0.tgz
libraries[react][download][branch] = 16.2.0
libraries[react][download][revision] = 
libraries[react-dom][type] = library
libraries[react-dom][download][type] = git
libraries[react-dom][download][url] = https://registry.npmjs.org/react-dom/-/react-dom-16.2.0.tgz
libraries[react-dom][download][branch] = 16.2.0
libraries[react-dom][download][revision] = 